        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link to="/#yhteydenotto" className="inline-flex items-center justify-center px-6 py-3 bg-white text-[#0F172A] font-semibold rounded-lg hover:bg-gray-100 transition-colors">
                Pyydä tarjous
              </Link>
              <a href={`tel:${settings?.company_phone_primary?.replace(/\s/g, '') || '+358400547270'}`} className="inline-flex items-center justify-center px-6 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">
                Soita nyt
              </a>
            </div>
          </motion.div>
